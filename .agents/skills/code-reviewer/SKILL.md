...
-   **Execution**: `python .agent/skills/code-reviewer/scripts/pr_analyzer.py [options] `
...
-   **Execution**: `python .agent/skills/code-reviewer/scripts/code_quality_checker.py [options] `
