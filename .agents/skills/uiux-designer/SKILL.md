...
python3 .agent/skills/uiux-designer/scripts/search.py "" --design-system -p "Project Name"

### Step 3: Supplement with Detailed Searches
python3 .agent/skills/uiux-designer/scripts/search.py "" --domain 

### Step 4: Stack Guidelines
python3 .agent/skills/uiux-designer/scripts/search.py "" --stack html-tailwind
