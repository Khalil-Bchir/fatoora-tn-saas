...
import { Upload, CheckCircle2, RefreshCw, X, FileText, Image as ImageIcon } from 'lucide-react'
...
export function MediaUploader({
  ...
  return (
    <div className="space-y-2">
      ...
      {value ? (
        <div className="relative group border border-zinc-200 dark:border-zinc-700 rounded-xl p-3 bg-zinc-50/70 dark:bg-zinc-800/40 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 overflow-hidden">
            {isPdf ? (
              <div className="w-12 h-12 rounded-lg bg-red-100 dark:bg-red-950/50 text-red-600 flex items-center justify-center shrink-0">
            ...
            <div className="overflow-hidden text-xs">
              ...
              <p className="text-[11px] text-zinc-400 font-mono truncate max-w-[220px]">
                {value.split('/').pop()}
              </p>
            </div>
          </div>
